 ...
 * @author R584285
 */
@ServerEndpoint(value = "/getorders", configurator = ServerEndPointConfigurator.class)
public class GetOrdersPoint implements Subscriber<AccountDetailsResponse> {

    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(GetOrdersPoint.class.getName());
