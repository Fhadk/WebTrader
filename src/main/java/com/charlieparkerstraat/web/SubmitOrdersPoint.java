 ...
 * @author R584285
 */
@ServerEndpoint(value = "/submitorders", configurator = ServerEndPointConfigurator.class)
public class SubmitOrdersPoint implements Subscriber<AccountDetailsResponse> {

    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(SubmitOrdersPoint.class.getName());
