 ...
 * @author R584285
 */
@ServerEndpoint(value = "/getstatement", configurator = ServerEndPointConfigurator.class)
public class GetStatementPoint implements Subscriber<AccountDetailsResponse> {

    private static final java.util.logging.Logger LOG = java.util.logging.Logger.getLogger(GetStatementPoint.class.getName());
