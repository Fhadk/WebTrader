...
Ext.Loader.addClassPathMappings({
  ...
  "Ext.ux.WebSocket": "ext/src/ux/WebSocket.min.js",
  "Ext.ux.data.proxy.WebSocket": "ext/src/ux/data/proxy/WebSocketProxy.min.js",
  "ExtThemeNeptune": "ext/packages/ext-theme-neptune/overrides"
});

Ext.ClassManager.addNameAlternateMappings({
  "Dashboard.model.AccountDetailsModel": [],
  "Dashboard.model.AccountFundsModel": [],
  "Dashboard.model.AccountStatementModel": [],
  "Dashboard.store.AccountDetailsStore": [],
  "Dashboard.store.AccountFundsStore": [],
  "Dashboard.store.AccountStatementStore": [],
  "Dashboard.view.RootViewport": [],
...
Ext.setVersion("ext-theme-neptune-cc00cfa9-ef30-49d5-9e9b-69b488875a6c", "1.0.0");
